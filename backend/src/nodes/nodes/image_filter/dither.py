...
class DitherNode(NodeBase):
    def __init__(self):
        ...
        self.inputs = [
            ...
            if_group(Cond.enum(2, UniformDitherAlgorithm.ORDERED))(
                EnumInput(
                    ThresholdMap,
            ...
            if_group(Cond.enum(2, UniformDitherAlgorithm.DIFFUSION))(
                EnumInput(
                    ErrorDiffusionMap,
            ...
            if_group(Cond.enum(2, UniformDitherAlgorithm.RIEMERSMA))(
                NumberInput(
                    "History Length",
                    minimum=2,
                    default=16,
