...
@batch_processing_group.register(
    ...
    description="Iterate over all files in a directory and run the provided nodes on just the PyTorch model files (.pth). Supports the same models as [Load Model](#chainner:pytorch:load_model).",
    icon="MdLoop",
    inputs=[
        DirectoryInput(),
    ],
