...
@value_group.register(
    ...
    outputs=[
        ...
        BaseOutput(output_type="Input1", label="Value 2"),
        BaseOutput(output_type="Input2", label="Value 3"),
        BaseOutput(output_type="Input3", label="Value 4"),
        BaseOutput(output_type="Input4", label="Value 5"),
        BaseOutput(output_type="Input5", label="Value 6"),
        BaseOutput(output_type="Input6", label="Value 7"),
        BaseOutput(output_type="Input7", label="Value 8"),
        BaseOutput(output_type="Input8", label="Value 9"),
