...
@batch_processing_group.register(
    ...
    description="Iterate over all files in a directory and run the provided nodes on just the image files. Supports the same file types as [Load Image](#chainner:image:load).",
    icon="MdLoop",
    node_type="iterator",
    inputs=[
        DirectoryInput(),
