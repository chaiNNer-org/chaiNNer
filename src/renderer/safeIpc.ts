...
import { mockIpcRenderer } from './mockIpc';
...
const createElectronIpcRenderer = (): SafeIpcRenderer => {
    return {
...
export const ipcRenderer: SafeIpcRenderer = isElectron()
    ? createElectronIpcRenderer()
    : (mockIpcRenderer as unknown as SafeIpcRenderer);
